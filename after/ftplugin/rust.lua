...
nmap("<leader><Up>", function() vim.cmd.RustLsp { 'moveItem', 'up' } end, "Rust Move Item Up", { buffer = bufnr })
nmap("<leader><Down>", function() vim.cmd.RustLsp { 'moveItem', 'down' } end, "Rust Move Item Down", { buffer = bufnr })
